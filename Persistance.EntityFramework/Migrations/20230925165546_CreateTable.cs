    ...
    public partial class CreateTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new Guid("481cf36a-fdb8-4911-853f-34ad26df4a2a"), "Nail Polish", 100m },
                    { 2, new Guid("481cf36a-fdb8-4911-853f-34ad26df4a2a"), "Hair Brush", 500m },
                    { 3, new Guid("1db7a052-91d5-43f0-8eeb-c852b504cd59"), "Shaving Cream", 90m }
                });
